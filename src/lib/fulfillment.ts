...
export function strategyFor(mode: FulfillmentMode, categoryId?: string): FulfillmentStrategy {
  ...
  if (categoryId === "davet" || categoryId === "dikis" || categoryId === "tamir" || categoryId === "teknoloji" || categoryId === "araba" || categoryId === "kurye" || categoryId === "bahce" || categoryId === "kargo" || categoryId === "cikti" || categoryId === "kislik" || categoryId === "hali" || categoryId === "odev" || categoryId === "dil") {
    return foodStrategy;
  }
