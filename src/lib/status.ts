...
export function nextStatus(
  ...
  if (food || packageId === "davet" || packageId === "dikis" || packageId === "tamir" || packageId === "teknoloji") {
...
export function trackSteps(packageId: PackageId | "davet" | "dikis" | "tamir" | "teknoloji", food = false): OrderStatus[] {
  if (food || packageId === "davet" || packageId === "dikis" || packageId === "tamir" || packageId === "teknoloji") {
