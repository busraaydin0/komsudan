...
export function LaundryProfile({
  ...
  useEffect(() => {
    if (!me || me.categoryId === "davet" || me.categoryId === "dikis" || me.categoryId === "tamir" || me.categoryId === "teknoloji") return;
    setBio(me.bio);
  ...
  if (!me || me.categoryId === "davet" || me.categoryId === "dikis" || me.categoryId === "tamir" || me.categoryId === "teknoloji") return null;
